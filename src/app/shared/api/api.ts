...
export class EgressClient {
    ...
    previewData(datasetId: string, fromDate: string | null | undefined, toDate: string | null | undefined): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Egress/preview/{datasetId}?";
        if (datasetId === undefined || datasetId === null)
            throw new Error("The parameter 'datasetId' must be defined.");
        url_ = url_.replace("{datasetId}", encodeURIComponent("" + datasetId));
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPreviewData(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPreviewData(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPreviewData(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class DatasetChangeLog extends Created implements IDatasetChangeLog {
    ...
    datasetPermissionChange?: DatasetPermissionChange | undefined;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.datasetChangeType = _data["datasetChangeType"];
            this.datasetPermissionChange = _data["datasetPermissionChange"] ? DatasetPermissionChange.fromJS(_data["datasetPermissionChange"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["datasetChangeType"] = this.datasetChangeType;
        data["datasetPermissionChange"] = this.datasetPermissionChange ? this.datasetPermissionChange.toJSON() : <any>undefined;
        super.toJSON(data);
        return data; 
    }
}
...
export class DatasetPermissionChange implements IDatasetPermissionChange {
    ...
    constructor(data?: IDatasetPermissionChange) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.permissionChangeType = _data["permissionChangeType"];
            this.accessType = _data["accessType"];
            this.accessMemberType = _data["accessMemberType"];
            this.displayName = _data["displayName"];
            this.mail = _data["mail"];
        }
    }

    static fromJS(data: any): DatasetPermissionChange {
        data = typeof data === 'object' ? data : {};
        let result = new DatasetPermissionChange();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["permissionChangeType"] = this.permissionChangeType;
        data["accessType"] = this.accessType;
        data["accessMemberType"] = this.accessMemberType;
        data["displayName"] = this.displayName;
        data["mail"] = this.mail;
        return data; 
    }
...
export interface IDatasetPermissionChange {
    permissionChangeType: PermissionChangeType;
    accessType: AccessType;
    accessMemberType: AccessMemberType;
    displayName?: string | undefined;
